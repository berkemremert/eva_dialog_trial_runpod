...
Qwen3-Omni consumes the Turkish audio directly and writes the response. Cartesia is used only to
speak that response in Turkish. Qwen's built-in talker is disabled, saving roughly 10 GB of GPU
VRAM.
...
- Container image: `qwenllm/qwen3-omni:3-cu124`
- An 80 GB GPU, or multiple GPUs with at least 80 GB total VRAM
...
The first start downloads the model. When `Model hazır` appears, open port 7860 from RunPod's
